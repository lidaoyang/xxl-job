...
public class JobCompleter {
    ...
    private void processChildJob(XxlJobLog xxlJobLog) {
        ...
        StringBuilder triggerChildMsg = new StringBuilder();
        if (XxlJobContext.HANDLE_CODE_SUCCESS == xxlJobLog.getHandleCode()) {
            ...
            if (xxlJobInfo != null && StringTool.isNotBlank(xxlJobInfo.getChildJobId())) {
                triggerChildMsg.append("<br><br><span style=\"color:#00c0ef;\" > &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;")
            ...
            // 任务执行失败后停止
            if (xxlJobInfo != null && xxlJobLog.getHandleCode() != ResponseCode.SUCCESS.getCode() && xxlJobInfo.getExecutorFailStop()) {
        ...
        if (StringTool.isNotBlank(triggerChildMsg.toString())) {
