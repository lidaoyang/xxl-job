...
import com.xxl.job.admin.scheduler.alarm.msg.WebHookMsg;
...
public class BaseAlarm {
    ...
    public String parseContent(XxlJobInfo info, XxlJobLog jobLog) {
        ...
        if (jobLog.getTriggerCode() != ResponseCode.SUCCESS.getCode()) {
    ...
    private static String loadJobAlarmTemplate() {
        return I18nUtil.getString("jobconf_monitor_detail") + br +
