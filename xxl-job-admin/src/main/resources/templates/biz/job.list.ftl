                        ...
                        <form class="form-horizontal form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"><input type="text" class="form-control" name="author"
                                                             placeholder="${I18n.system_please_input}${I18n.jobinfo_field_author}"
                                                             maxlength="50"></div>
                                <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmType}
                            ...
                            <div class="form-group">
                                <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmUrl}<font
                                            color="black">*</font></label>
                                <div class="col-sm-4"><input type="text" class="form-control" name="alarmUrl"
                            ...
                            <div class="form-group">
                                <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_opt_next_time}<font
                                            color="black">*</font></label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control date-time" name="next_time_f"
                                           data-name="triggerNextTime"
                                           placeholder="${I18n.jobinfo_field_next_placeholder}" autocomplete="off"/>
                                    <input type="hidden" name="triggerNextTime" value="0"/>
                                </div>

                                <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_opt_ent_time}<font
                                            color="black">*</font></label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control date-time" name="end_time_f"
                                           data-name="endTime" placeholder="${I18n.jobinfo_field_endTime_placeholder}"
                                           autocomplete="off"/>
                            ...
                            <div class="form-group">
                                ...
                                <label for="lastname"
                                       class="col-sm-2 control-label">${I18n.jobinfo_field_executorFailStop}<font
                                            color="black">*</font></label>
                                <div class="col-sm-4">
    ...
    $(function () {
        ...
        $.adminTable.initTable({
            ...
            columns: [
                ...
                {
                    title: I18n.jobinfo_field_addTime,
                    field: 'addTime',
                    width: '13',
                    widthUnit: '%',
                    formatter: function (value, row, index) {
                ...
                {
                    title: I18n.jobinfo_field_updateTime,
                    field: 'updateTime',
                    width: '13',
                    widthUnit: '%',
                    formatter: function (value, row, index) {
                ...
                },
                {
                    ...
                    title: I18n.jobinfo_field_alarmUrl,
                    field: 'alarmUrl',
                    width: '15',
                    widthUnit: '%'
                },
                {
                    title: I18n.jobinfo_opt_last_time,
                ...
                {
                    title: I18n.jobinfo_opt_ent_time,
                    field: 'endTime',
                    width: '13',
                    widthUnit: '%',
                    formatter: function (value, row, index) {
